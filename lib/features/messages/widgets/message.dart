              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    ...
                    bottomLeft:
                        message.sentByUid == currentUser.uid ? const Radius.circular(16) : const Radius.circular(0),
                    bottomRight:
                        message.sentByUid == currentUser.uid ? const Radius.circular(0) : const Radius.circular(16),
                  ),
                ),
                child: Text(

import 'package:courtfinder/features/user_profile/view/blocked.dart';
          ...
          children: [
            ...
            Expanded(
              ...
              children: [
                ...
                ListTile(
                  leading: const Icon(Icons.block, size: 30, color: Pallete.blackColor),
                  title: const Text('屏蔽', style: TextStyle(fontSize: 22, color: Pallete.blackColor)),
                  onTap: () {
                    Navigator.push(context, BlockedUsersView.route());
                  },
                )
              ],
            )),

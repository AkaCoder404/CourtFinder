...
//
final searchTweetsProvider = FutureProvider.family((ref, String keyword) async {
  final tweetController = ref.watch(tweetControllerProvider.notifier);
  return tweetController.searchTweetsByKeyword(keyword);
});
...
class TweetController extends StateNotifier<bool> {
  ...
  Future<List<Tweet>> searchTweetsByKeyword(String keyword) async {
    final documents = await _tweetAPI.searchTweetByKeyword(keyword);
    return documents.map((tweet) => Tweet.fromMap(tweet.data)).toList();
  }
  ...
  void _shareImageTweet({
    ...
    state = true; // TODO: understand what this does?

        ...
        : ref.watch(userDetailsProvider(tweet.uid)).when(
              data: (user) {
                ...
                return GestureDetector(
                  onTap: () => Navigator.push(context, TwitterReplyScreen.route(tweet)),
                  child: Column(
                    children: [
                      Row(
                                          ...
                                          children: [
                                            ...
                                            TweetIconButton(
                                              ...
                                              onTap: () {
                                                ...
                                                print("Fav 1 ${currentUser.favorites.length}");
                                                ref
                                                ...
                                                print("Fav 2 ${currentUser.favorites.length}");
                                              },
                                            ),
                                            // Like tweet button
                                            LikeButton(

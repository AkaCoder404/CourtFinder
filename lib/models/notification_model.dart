...
class Notification {
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'notifiedAt': notifiedAt.millisecondsSinceEpoch});
  ...
  factory Notification.fromMap(Map<String, dynamic> map) {
    return Notification(
      ...
      id: map['\$id'] ?? '',
      uid: map['uid'] ?? '',
      notifiedAt: DateTime.fromMillisecondsSinceEpoch(map['notifiedAt']),
  ...
  @override
  String toString() {
    return 'Notification(text: $text, postId: $postId, id: $id, uid: $uid, notifiedAt: $notifiedAt, notificationType: $notificationType)';
  }

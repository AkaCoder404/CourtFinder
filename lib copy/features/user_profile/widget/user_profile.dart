  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return currentUser == null
        ...
        : Scaffold(
            ...
            appBar:
                MyAppBar(title: user.name, backButton: currentUser.uid == user.uid ? true : false, context: context),
...
class MyAppBar extends StatelessWidget with PreferredSizeWidget {
  ...
  const MyAppBar({super.key, required this.title, required this.backButton, required this.context});

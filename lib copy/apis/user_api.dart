...
abstract class IUserAPI {
  ...
  // Tweet related
  // FutureEither<model.Document> favoriteTweet(UserModel user);

  // User profile related
  // Future<List<model.Document>> getUserFollowers(String uid);

  // Chat related
  FutureEitherVoid addToChatList(UserModel user);

  // Future<List<model.Document>> getFollowingUsers(String uid); // Get following
}
